...
int main(int ac, char **av)
{
    ...
    //     size_t j = 0;
        ...
        {
            // //"\n\nlocation ----------------------------\n";
            // //"=====> " << parse.s[i]->l[i]->allowed_methods[0] << " <====== \n";
            // //"=====> " << parse.s[i]->l[i]->allowed_methods[1] << " <====== \n";
            ...
            while (it_b != it_e) 
            {
                if ((*it_b).first == "location")
                    // //"hooooooo" << (*it_b).first << " " << (*it_b).second << "\n";
                // if ((*it_b).first == "root")
                //     // //(*it_b).first << " " << (*it_b).second << "\n";
                // if ((*it_b).first == "index")    
                //     // //(*it_b).first << " " << (*it_b).second << "\n";
    ...
    while (1)
    {
        ...
        // // //"buffer = " << std::string(buffer, rd_sock) << std::endl;
        printf ("--> %s \n", buffer);
    ...
    //         // //"New connection, socket fd is " << newSocket << ", IP is: "
    ...
    //         {
    //             // //"deja t create had socketDes an it ready to read data from it => " << socketDesc << std::endl;   
    ...
    //     {
    //         // //"\n\nlocation ----------------------------\n";
    //         // //"=====> " << parse.s[a]->l[k]->allowed_methods[0] << " <====== \n";
    //         // //"=====> " << parse.s[a]->l[k]->allowed_methods[1] << " <====== \n";
    ...
    //         {
    //             if ((*it_b).first == "location")
    //                 // //"hooooooo " << (*it_b).first << " second == " << (*it_b).second << "\n";
    //             // if ((*it_b).first == "root")
    //             //     // //(*it_b).first << " " << (*it_b).second << "\n";
    //             // if ((*it_b).first == "index")    
    //             //     // //(*it_b).first << " " << (*it_b).second << "\n";
